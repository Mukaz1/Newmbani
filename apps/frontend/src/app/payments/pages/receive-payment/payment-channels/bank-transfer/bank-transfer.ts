...
import { BankTransferPaymentsService } from '../../../../services/bank-transfer-payments.service';
...
export class BankTransfer implements OnChanges, OnInit {
  ...
  paymentService = inject(BankTransferPaymentsService);
  ...
  submitPayment() {
    if (this.paymentForm.valid) {
      ...
      const paymentData: CreateBankTransferPayment = {
        invoiceId,
        customerId,
        paymentDate,
