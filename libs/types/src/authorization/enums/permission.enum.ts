...
export enum PermissionEnum {
  ...
  CREATE_COMMSSION = 'create-commission',
  VIEW_COMMSSION = 'view-commission',
  UPDATE_COMMSSION = 'update-commission',
...
export const ModulePermissions = {
  ...
  // COMMISSIONS
  commission: [
    PermissionEnum.CREATE_COMMSSION,
    PermissionEnum.VIEW_COMMSSION,
    PermissionEnum.UPDATE_COMMSSION,
